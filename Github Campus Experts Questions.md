 ...
 **Whatsapp groups, Telegram & Slack** for the program to help students share their feedbacks and doubts.
...
- The measure of the success will be assessed by the number of new people joining the events, workshops and open source development. Importantly count of increase in freshmen participation in the events & number of community project that will be delivered at the end of 1 year.
- Each session which will span about 3 months. I will iterate on community plans at the end of each session.

**EVERYONE WILL BE TREATED EQUALLY WHETHER HE/SHE IS A CODER OR BEGINNER**
...
Every month, survey will be conducted to check what possible changes will be done to maximize the effecieny and enhancement of the club .
It also makes easier for other persons in the club to maintain the same Harmony in the FUTURE.
...
There must be no Discrimination on the basis levels of coders all are equal in the eyes of leader this condiion makes future-proof community & If someone not follows the rules they will be punishes and no one will be tolerated.
...
**These Qualities must be there in the (SUCCESSOR) person.**

- How will you handover to new community leaders?

**All depends upon the person capabilities which i mentioned above and the survey also conducted to check whether the person was really capable of that as all persons as same right to choose their leader.**
